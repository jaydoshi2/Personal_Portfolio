...
const Contact = () => {
  ...
  const handleChange = (e) => {
    ...
    // Clear error message for field being edited
    if (errors[name]) {
    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "Jay.Doshi@rockets.utoledo.edu",
    ...
    <div className='xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden'>
      ...
      >
        ...
        >
          ...
          <button
            type='submit'
            className='mt-4 bg-tertiary py-3 px-8 rounded-xl text-white font-bold shadow-md shadow-primary w-fit'
          >
